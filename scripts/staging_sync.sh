...
for IMG_FILE in */*.ext2 */*.ext4 */*.zip */*.bin */*.ubi */*.ubifs */*.img */*.jffs2 */*.sum.jffs2 */*.jffs2.nosummary */*.tgz */*.tar.gz */*.tar.bz2 */*.udfu */*.fastboot */*.cpio.gz */*.rpi-sdimg */*.rpi-sdimg.gz */*.wic.gz */*.wic.bmap; do
